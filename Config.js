...
//contact details
global.ownernumber = [ process.env.OWNER_NUMBER || "+233558012648"],
global.ownername = process.env.OWNER_NAME || "Raybrute(IRA)",
global.location = "Ghana"

global.botname = process.env.BOTNAME || "IRA",//name of the bot
